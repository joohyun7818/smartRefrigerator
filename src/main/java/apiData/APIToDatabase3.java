...
public class APIToDatabase3 {
    public static void main(String[] args) {
    	int start = 0, end = 0;
        for (start=1; start<=6200; start += 100) {
        	end = start + 99;
	        String apiUrl = "http://211.237.50.150:7080/openapi/ceeb44594d730a64c66ee29df505351cc998fc623e95511472cad313381bdc56/xml/Grid_20150827000000000228_1/"
	        ...
	        try {
	            ...
	            for (int i = 0; i < rows.getLength(); i++) {
	                ...
	                int rpid = Integer.parseInt(row.getElementsByTagName("RECIPE_ID").item(0).getTextContent());
	                int cookNum = Integer.parseInt(row.getElementsByTagName("COOKING_NO").item(0).getTextContent());
	                String step = row.getElementsByTagName("COOKING_DC").item(0).getTextContent();
	                
	
	                // 데이터 삽입
	                statement.setInt(1, rpid);
	                statement.setInt(2, cookNum);
