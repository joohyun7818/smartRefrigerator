...
public class APIToDatabase {
    public static void main(String[] args) {
        ...
        for (start=1; start<=6200; start += 100) {
	        ...
	        String apiUrl = "http://211.237.50.150:7080/openapi/ee038d795bc2ae194a109b7a6f29fd9bc416435a9f4c1218c9e704fb1a5edabd/xml/Grid_20150827000000000227_1/"
	        ...
	        try {
	            ...
	            String sql = "INSERT INTO recipe (rid, iName, quantity) VALUES (?, ?, ?)";
	            ...
	            for (int i = 0; i < rows.getLength(); i++) {
	                ...
	                int recipeId = Integer.parseInt(row.getElementsByTagName("RECIPE_ID").item(0).getTextContent());
	                ...
	                statement.setString(2, irdntNm);
	                statement.setString(3, irdntCpcty);
